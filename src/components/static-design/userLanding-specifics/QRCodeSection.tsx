        ...
        <div className="flex flex-col gap-2 lg:gap-4 bg-white rounded-3xl p-4 lg:p-6">
            <div className="flex justify-between">
                ...
                <div className="flex gap-2 items-center">
                    ...
                    <div className="cursor-pointer rounded-full bg-[#FBE7EE] flex items-center w-8 h-8 justify-center lg:hidden">
                        <Image src="/assets/arrow-up.svg" alt="arrow" width={16} height={16} />
                    </div>
                </div>
            </div>
            <div className="flex gap-2 p-4 items-center bg-[#FFF5E9] rounded-2xl">
                <Image src="/assets/document-download-2.svg" alt="download" width={24} height={24} />
                <p className="text-[#333333] text-xs">Download the QR code or share it with your friends.</p>
            </div>
            <div className="bg-gradient-to-r from-[#D20653] to-[#FF951D] rounded-[20px] flex justify-center items-center">
                <div className="bg-white rounded-[20px] flex flex-col justify-center items-center gap-1 w-[90%] h-[90%]">
                    ...
                    <div className="flex flex-col items-center justify-center">
                        <Image src="/assets/qr.png" alt="QR Code" width={100} height={100} />
